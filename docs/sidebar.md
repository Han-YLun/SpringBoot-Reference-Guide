...
* [使用Spring Boot](zh-cn/UseSpringBoot/index.md)
	...
	* [3.配置类](zh-cn/UseSpringBoot/)
		* [3.1 导入其他配置类](zh-cn/UseSpringBoot/)
		* [3.2 导入xml配置](zh-cn/UseSpringBoot/)
	* [4.自动配置](zh-cn/UseSpringBoot/)
		* [4.1 逐渐取代自动配置](zh-cn/UseSpringBoot/)
		* [4.2 禁用特定的自动配置类](zh-cn/UseSpringBoot/)
